...
public class GrpcAuctionClient
{
    ...
    {
        _logger.LogInformation("Calling grpc auction");
        var channel = GrpcChannel.ForAddress(_config["GrpcAuction"]);
        var client = new AuctionService.Protos.AuctionService.AuctionServiceClient(channel);
        ...
        {
            _logger.LogError(e,"couldn't call grpc server");
            return null;
        }
    }
}
